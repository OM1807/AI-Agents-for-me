...
export function DocumentIntegration({
  ...
  const content = {
    prd: {
      ...
      title: 'Attach Product Requirements',
      heading: 'Attach Product Requirements',
      subheading:
        'Link your product specifications and feature definitions to enable intelligent analysis of your project scope and requirements.',
      buttonText: 'Attach Requirements',
      addButtonText: 'Attach Requirements',
    },
    supporting_doc: {
      smallIcon: <FileIcon className='h-4 w-4' />,
      icon: <FileIcon className='h-16 w-16' />,
      title: 'Include Reference Materials (Optional)',
      heading: 'Include Reference Materials',
      subheading:
        'Enhance analysis accuracy by providing technical documentation, architecture diagrams, and contextual resources.',
      buttonText: 'Include Materials',
      addButtonText: 'Include Materials',
    },
    logging: {
      smallIcon: <LogsIcon className='h-4 w-4' />,
      icon: <LogsIcon className='h-16 w-16' />,
      title: 'Integrate Log Streams (Optional)',
      heading: 'Integrate Log Streams',
      subheading:
        'Link monitoring platforms like PagerDuty, Sentry, and Datadog to access live application logs for deeper insights.',
      buttonText: 'Integrate Logs',
      addButtonText: 'Integrate Logs',
    },
    incident: {
      smallIcon: <LinkIcon className='h-4 w-4' />,
      icon: <LinkIcon className='h-16 w-16' />,
      title: 'Link Incident Tracking System',
      heading: 'Link Incident Tracking System',
      subheading:
        'Connect your incident management tools to pull real-time alerts and historical incident data for analysis.',
      buttonText: 'Link Incident System',
      addButtonText: 'Link Incident System',
    },
    file: {
      smallIcon: <FileIcon className='h-4 w-4' />,
      icon: <FileIcon className='h-16 w-16' />,
      title: 'Import Local Resources',
      heading: 'Import Local Resources',
      subheading:
        'Directly upload files from your device to provide additional context for the analysis engine.',
      buttonText: 'Import Resources',
      addButtonText: 'Import Resources',
    },
  };
